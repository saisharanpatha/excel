...
$("#load").click(function(){
    $('textarea[row="1"]').each(function(){    
		...
		//$(this).val(value);
		if($(this).find('.contentText').text()==value)
		
$(this).parent().parent().find('.contentText').text($(this).val(value));
...
var totalColumns = 10;
    ...
    var tablesToExcel = (function () {
        ...
        , tmplWorkbookXML = '<?xml version="1.0"?><?mso-application progid="Excel.Sheet"?><Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet">'
          + '<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office"><Author>Sharan</Author><Created>{created}</Created></DocumentProperties>'
          + '<Styles>'
...
$("#italicit").click(function() {
	if($(this).hasClass("active")){
		$(this).removeClass("active");
		$(".ui-selected").removeClass("italic");
	}else{
		$(".ui-selected").addClass("italic");
		$(this).addClass("active");
	}
});
$("#underlineit").click(function() {
	if($(this).hasClass("active")){
		$(this).removeClass("active");
		$(".ui-selected").removeClass("ul");
	}else{
		$(".ui-selected").addClass("ul");
		$(this).addClass("active");
	}
});
